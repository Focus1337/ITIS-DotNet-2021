...
{
    public static string GetFightLog(Character player, Monster monster)
    {
    ...
    private static void Attack(Character character1, Monster character2, StringBuilder stringBuilder)
    {
    ...
    private static void Attack(Monster character1, Character character2, StringBuilder stringBuilder)
    {
        for (var i = 0; i < character1.AttackPerRound; i++)
        {
            var random = Random.Shared.Next(20) + 1;
